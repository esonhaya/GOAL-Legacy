...
final class Bootstrap
{
    ...
    public function create(?string $projectRoot = null, ?array $environment = null): CoreServices
    {
        ...
        $nationalTeams = new NationalTeamService($nationModule->service(), $pulseService);
        $internationalCompetitions = new InternationalCompetitionService($clubModule->service(), $nationalTeams, $pulseService);
        ...
        $matchModule = new MatchModule(new MatchService($clubModule->service(), $dispatcher, $developmentService, $expectationService, $availabilityService, $domesticCups, $europeanCompetitions, $internationalCompetitions, $footballSocialService, new ManagerTrustService()));
