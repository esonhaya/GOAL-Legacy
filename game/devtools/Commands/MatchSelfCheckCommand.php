...
final class MatchSelfCheckCommand implements CommandInterface
{
    ...
    public function execute(array $arguments, ConsoleOutputInterface $output): int
    {
        ...
        try {
            ...
            $population = $playerService->populationService()->populate($database, $season, $world->universeSeed()); if ($population['players_total'] !== 2400) { throw new RuntimeException('Population did not create the expected full Big-5 ecosystem.'); }
