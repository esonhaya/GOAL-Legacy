...
final class CareerLabels
{
    ...
    private const LABELS = [
        ...
        'competing_for_start' => 'Competing for a Start',
        'rotation_battle' => 'Rotation Battle',
        'backup' => 'Backup',
        'position_open' => 'Position Open',
        'above_expectation' => 'Above Expectation',
        'on_track' => 'On Track',
        'below_expectation' => 'Below Expectation',
        'severely_below_expectation' => 'Severely Below Expectation',
        ...
        'european_qualification' => 'European Qualification',
        'top_half' => 'Top Half',
        'stable_season' => 'Stable Season',
        'avoid_relegation' => 'Avoid Relegation',
        'promotion_challenge' => 'Promotion Challenge',
        'compete' => 'Compete',
        'reach_later_rounds' => 'Reach Later Rounds',
        'serious_contender' => 'Serious Contender',
