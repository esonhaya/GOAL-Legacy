...
final readonly class CareerPlayerReference
{
    ...
    {
        return new self($this->careerId, $this->playerId, $this->startDate, CareerTransferRequestStatus::Requested, $seasonId);
    }

    public function withoutTransferRequest(): self
    {
        return new self($this->careerId, $this->playerId, $this->startDate);
    }
