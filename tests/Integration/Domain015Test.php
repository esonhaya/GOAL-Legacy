...
final class Domain015Test extends TestCase
{
    ...
    public function testFreePlayerReuseAndCheckpointRetryAreIdempotent(): void
    {
        ...
        self::assertCount(1, array_filter($registrations->byPlayer($free->id()), static fn (PlayerRegistration $registration): bool => $registration->seasonId()->value() === $season->id()->value() && $registration->clubId()->value() === 'arsenal'));
    }
